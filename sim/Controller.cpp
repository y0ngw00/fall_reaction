	...
	terminationReason(-1),mIsNanAtTerminal(false), mIsTerminal(false)
{
	...
	#ifdef OBJECT_TYPE
		this->mCGOBJ = collisionEngine->createCollisionGroup(this->mObject->getBodyNode("Jump_Box"));
		this->mCGOBJ2 = collisionEngine->createCollisionGroup(this->mObject2->getBodyNode("Jump_Box2"));
	#endif
